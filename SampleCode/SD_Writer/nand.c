/******************************************************************************
 * @file     nand.c
 * @brief    support NAND access function
 *
...
// global variables
UINT32 g_uIsUserConfig; //nand  //CWWeng 2018.11.15 copy from NuWriter FW parse.c
...
//    if (_usbd_bIsFMIInit == FALSE) 
        ...
        // CWWeng 2018.11.15 initial SD and FMI at the same time
				// SD Initial
        outpw(REG_SDH_DMACTL, DMAC_CSR_SWRST | DMAC_CSR_EN);
        while(inpw(REG_SDH_DMACTL) & DMAC_CSR_SWRST);
				// FMI Initial
